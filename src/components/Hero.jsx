...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      <div className={`absolute inset-0 top-[96px] h-[calc(50vh-48px)] w-full z-10 mx-auto ${styles.paddingX} flex flex-row items-start justify-start gap-5`}>
        ...
        <div>
          ...
          <div className="text-2xl font-extrabold mt-2">
            And I'm a <span className="text-[#53C1DE] custom-typewriter"><Type /></span>
          </div>
